...
3. Confirm what was stored and suggest running `prociq_trigger_consolidation` if enough teachings have accumulated

Example usage:
- `prociq.teach When using Detox with animations, always add explicit waitFor timeouts of at least 5000ms`
- `prociq.teach The auth module requires running migrations before tests`
